    ...
    <Layout>
      <Container>
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            Umar is a Software Developer based in St. John&apos;s with a passion for building strange stuff. He has a
            knack for all things, from planning and designing all the way
            to solving real-life problems. When not coding, he loves to play video games (currently striving for
            platinum in {' '}
        ...
        <Section delay={0.2}>
          ...
          <BioSection>
            ...
            Working with {' '}
            <Link href={'https://www.linkedin.com/company/skillshawks/'} target={'_blank'}> Creatros Technologies
              Inc </Link>, Canada
          </BioSection>
          <BioSection>
